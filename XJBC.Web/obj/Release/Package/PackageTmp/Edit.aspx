...
<body>
    <form id="myform" runat="server">
        ...
        <div class="insert">
            <asp:TextBox ID="Title" name="Title" runat="server" placeholder="&nbsp;Title"></asp:TextBox>
...
<script src="lib/qiniu/js/plupload/plupload.full.min.js"></script>
<script src="lib/qiniu/js/plupload/i18n/zh_CN.js"></script>
<script src="lib/qiniu/js/qiniu.min.js"></script>
<script>
    function uploadInit() {
        var editor = this;
